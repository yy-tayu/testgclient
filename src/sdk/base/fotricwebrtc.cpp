...
IR_WEBRTC_API void ir_webrtc_register_message(std::function<void(const string& remote_user_id, const string message)> message_callback)
{
	return g_observer->SetReceiveMessageCallback(message_callback);
}

IR_WEBRTC_API void ir_webrtc_unpublish()
{
